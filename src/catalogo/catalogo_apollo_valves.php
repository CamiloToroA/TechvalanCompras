...
<head>
    ...
    <title>Catálogo - Motores </title>
    <!-- <link rel="icon" type="image/x-icon" href="assets/img/favicon.ico" /> --> <!-- ÍCONO -->
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            <div class="widget-content widget-content-area px-0 pt-0 product-cat11">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="card">
                                            <img src="assets/img/550x520.jpg" alt="image-product" class="image">
                                            <div class="card-overlay">
                                                <div class="row mt-4 card-top-section">
                                                    <div class="col-sm-6 col-6">
                                                        <p>Lens for Nikon DSLR</p>
                                                    </div>
                                                    <div class="col-sm-6 col-6">
                                                        <span class="badge badge-default">-20%</span>
                                                    </div>
                                                </div>
                                                <div class="row card-middle-section">
                                                    <div class="col-sm-6 col-6">
                                                        <button class="btn btn-default">Cotizar</button>
                                                    </div>
                                                    ...
                                                    <div class="col-sm-3 col-3 pl-0">
                                                        <p class="">
                                                            <i class="flaticon-share-line"></i>
                                                        </p>
                                                    </div>
                                                </div>
                                                <div class="row card-bottom-section">
                                                    <div class="col-sm-12">
                                                        <h3 class="card-title">Tamron 70-300mm</h3>
                                                        <p class="card-pricing">$235.00</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
